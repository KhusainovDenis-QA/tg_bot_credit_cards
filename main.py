...
bot = TeleBot(token='6393238599:AAF0DaQQ1Pq2xdILMNPlH86ulXK8nKU-Ydo', parse_mode='html') # создание бота
...
card_type_keybaord.row(
    ...
    types.KeyboardButton(text='Ссылка на номер, год, cvv'),
)
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        bot.send_message (message.chat.id, '2200 0000 0000 0004, 2200 0000 0000 0012, 2200 0000 0000 0020, 2200 0000 0000 0038, 2200 0000 0000 0046, 2200 0000 0000 0053'),
    elif message.text == 'Ссылка на номер, год, cvv':
        bot.send_message (message.chat.id, 'https://pay.alfabank.ru/ecommerce/instructions/merchantManual/pages/index/test_cards.html')
    else:
